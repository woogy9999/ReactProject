...
import {fetchShopList} from "../../actions/guestActions";

function ShopList() {
    const dispatch = useDispatch();
    const [curpage, setCurpage] = useState(1);
    useEffect(() => {
        dispatch(fetchShopList(curpage));
    }, [curpage]);

    const guestList=useSelector(state=>state.guests.shop_list)
            ...
            <div id="wrapper">
                ...
                <div id="main">
                    ...
                    <article className="post">
                        <header>
                            <div className="title">
                                <h2><a href="#">쇼핑 리스트</a></h2>
                                <p>페이지를 선택하여 원하는 쇼핑을 찾아보세요</p>
                            </div>
                            <div className="meta">
