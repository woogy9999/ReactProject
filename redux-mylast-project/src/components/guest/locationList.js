...
import {fetchLocationList} from "../../actions/guestActions";

function LocationList() {
    const dispatch = useDispatch();
    const [curpage, setCurpage] = useState(1);
    useEffect(() => {
        dispatch(fetchLocationList(curpage));
    }, [curpage]);

    const guestList=useSelector(state=>state.guests.location_list)
            ...
            <div id="wrapper">
                ...
                <div id="main">
                    ...
                    <article className="post">
                        <header>
                            <div className="title">
                                <h2><a href="#">문화 리스트</a></h2>
                                <p>페이지를 선택하여 원하는 문화를 찾아보세요</p>
                            </div>
                            <div className="meta">
